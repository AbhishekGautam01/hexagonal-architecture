namespace Accounting.Infrastructure.DapperDataAccess.Repositories
{
    using Dapper;
    ...
    public class CustomerReadOnlyRepository : ICustomerReadOnlyRepository, ICustomerWriteOnlyRepository
    {
        ...
        public async Task Add(Customer customer)
        {
            ...
            {
                string insertCustomerSQL = "INSERT INTO Customer (Id, Name, SSN) VALUES (@Id, @Name, @Aadhar)";
                ...
                customerParameters.Add("@Aadhar", (string)customer.Aadhar, DbType.AnsiString);
        ...
        public async Task Update(Customer customer)
        {
            using (IDbConnection db = new SqlConnection(_connectionString))
            {
                string updateCustomerSQL = "UPDATE Customer SET Name = @Name, Aadhar = @Aadhar WHERE Id = @Id";
